...
<script type="text/javascript">
	...
	ajx.open("GET","showDiscount.jsp?range1="+a+"&range2="+b,true);
	ajx.send();
    }
</script>
 ...
 <section  class="sky-form">
					<h4 class="cate">Discounts</h4>
					 <div class="row row1 scroll-pane">
						 <div class="col col-4">
                                                     <label class="checkbox"><a  onclick="select(0,10)"><input type="checkbox" name="checkbox" checked=""><i></i>Upto - 10% (20)</a></label>
						 </div>
						 <div class="col col-4">
